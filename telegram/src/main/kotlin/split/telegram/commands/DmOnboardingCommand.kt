...
import split.telegram.DmCommandContext
    ...
    suspend fun handle(context: DmCommandContext) {
        telegramApi.sendMessage(
            ...
            "👋 Hi! I split expenses for groups of friends, right inside Telegram.\n\n" +
                ...
                "2. Once I'm in, everyone who wants to be <code>@mentioned</code> in /split should also send " +
                "me /start — same as you just did here\n" +
