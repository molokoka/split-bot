    ...
    StringSpec({
        ...
        "sendMessage posts chat_id and text as JSON and returns the sent message id" {
            ...
            requests
                ...
                .body
                .toByteArray()
                .decodeToString() shouldBe """{"chat_id":-100,"text":"hi","parse_mode":"HTML"}"""
        ...
        "editMessageText posts chat_id, message_id, text, and an optional keyboard" {
            ...
            api.editMessageText(
                ...
                keyboard =
                    InlineKeyboardMarkup(
                        inlineKeyboard = listOf(listOf(InlineKeyboardButton(text = "Confirm", callbackData = "split:confirm"))),
                    ),
            )
        ...
        "answerCallbackQuery omits text and show_alert when not given" {
            ...
            requests
                ...
                .body
                .toByteArray()
                .decodeToString() shouldBe """{"callback_query_id":"cbq1"}"""
        }
